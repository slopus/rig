...
const definitions: Readonly<Record<string, CodexCollaborationNamespaceDefinition>> = {
    followup_task: {
        name: "followup_task",
        description:
...
export function getCodexCollaborationNamespaceDefinition(
    name: string,
): CodexCollaborationNamespaceDefinition | undefined {
