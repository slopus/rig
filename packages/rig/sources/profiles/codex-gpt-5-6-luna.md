...
- Profile: [codex-gpt-5-6-luna.ts](./codex-gpt-5-6-luna.ts)
...
- Model entry: `gpt-5.6-luna`; tool mode `code_mode_only`; multi-agent version `v1`
- Capture metadata: [codex-gpt-5-6-luna.capture.json](./codex/codex-gpt-5-6-luna.capture.json)
...
The official tools are [codex-gpt-5-6-luna.tools.golden.json](./codex/codex-gpt-5-6-luna.tools.golden.json), Rig's computed tools are [codex-gpt-5-6-luna.tools.json](./codex/codex-gpt-5-6-luna.tools.json), and the standalone diff is [codex-gpt-5-6-luna.tools.patch](./codex/codex-gpt-5-6-luna.tools.patch).
...
````diff
diff --git a/codex-gpt-5-6-luna.golden.md b/codex-gpt-5-6-luna.md
index 62d69d4..5a06c40 100644
--- a/codex-gpt-5-6-luna.golden.md
+++ b/codex-gpt-5-6-luna.md
@@ -1,8 +1,8 @@
